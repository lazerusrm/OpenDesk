...
| R-004 | Partial | Address-book entries contain hashed secret material; plaintext storage is rejected. | Owner decision on passwordless/managed-password requirement. |
...
| R-007 | Partial | Audit database/log evidence proves useful connection, console, relay, and rendezvous visibility. | Final audit tier decision: launch intent, ingestion, or deeper integration. |
